...
type GetSettlementReconciliationRequest struct {
	// application/json
...
func (g GetSettlementReconciliationRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetSettlementReconciliationRequest) UnmarshalJSON(data []byte) error {
...
func (o *GetSettlementReconciliationRequest) GetAcceptMedia() *string {
	if o == nil {
		return nil
	}
...
func (o *GetSettlementReconciliationRequest) GetFetchSettlementReconRequest() *shared.FetchSettlementReconRequest {
	if o == nil {
		return nil
	}
...
func (o *GetSettlementReconciliationRequest) GetXAPIVersion() string {
	if o == nil {
		return ""
	}
...
func (o *GetSettlementReconciliationRequest) GetXIdempotencyKey() *string {
	if o == nil {
		return nil
	}
...
func (o *GetSettlementReconciliationRequest) GetXRequestID() *string {
	if o == nil {
		return nil
	}
	return o.XRequestID
...
type GetSettlementReconciliationResponse struct {
	ContentType string
	// OK
...
func (o *GetSettlementReconciliationResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *GetSettlementReconciliationResponse) GetFetchSettlementRecon() *shared.FetchSettlementRecon {
	if o == nil {
		return nil
	}
...
func (o *GetSettlementReconciliationResponse) GetHeaders() map[string][]string {
	if o == nil {
		return nil
	}
	return o.Headers
...
func (o *GetSettlementReconciliationResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *GetSettlementReconciliationResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
