...
func (s *tokenVault) GetAllSavedInstruments(ctx context.Context, customerID string, instrumentType string, xAPIVersion string, xRequestID *string, opts ...operations.Option) (*operations.FetchAllSavedInstrumentsResponse, error) {
